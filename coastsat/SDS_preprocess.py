...
def create_jpg(im_ms, cloud_mask, date, satname, filepath, vidType):
    """
...
def save_jpg(metadata, settings, vidType,**kwargs):
    """
    ...
    for satname in metadata.keys():
        ...
        for i in range(len(filenames)):
            ...
            create_jpg(im_ms, cloud_mask, date, satname, filepath_jpg, vidType)
