...
class Window(QMainWindow):
    ...
    def home(self):
        ...
        topLeftLabel = QLabel('Northwest Coordinate (decimal degrees)')
        ...
        topRightLabel = QLabel('Northeast Coordinate, (decimal degrees)')
        ...
        botLeftLabel = QLabel('Southwest Coordinate (decimal degrees)')
        ...
        botRightLabel = QLabel('Southeast Coordinate (decimal degrees)')
